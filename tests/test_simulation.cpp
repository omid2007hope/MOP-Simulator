...
int main()
{
    ...
    Target concrete {"Hardened Concrete", 2650.0, 200.0e6};
    ...
    std::cout << "         -> [PASS] Dynamic Pressure: " << (resSub.dynamic_pressure / 1e9)
              << " GPa (< 2.0 GPa Yield)\n";
    ...
    std::cout << "         -> [PASS] Kinetic Energy: " << (resHyper.kinetic_energy / 1e9)
              << " GJ\n";
    std::cout << "         -> [PASS] Dynamic Pressure: " << (resHyper.dynamic_pressure / 1e9)
              << " GPa (> 2.0 GPa Yield)\n";
    std::cout
        << "         -> [PASS] Hydrodynamic failure and premature detonation correctly detected.\n";
    std::cout << "         -> [PASS] Hydrodynamic Penetration Limit: " << resHyper.hydro_penetration
              << " m\n\n";

    // Test 3: Orbital Kinetic Strike ("Rods from God" Tungsten Rod, 3400 m/s)
    std::cout << "[Test 3] Testing Orbital Tungsten Kinetic Rod (3400 m/s, 0 GPa Yield, 0 "
                 "Explosive Mass)...\n";
    ...
    std::cout << "         -> [PASS] Identified as Kinetic Rod (Zero explosive mass & zero yield "
                 "limit).\n";
    std::cout << "         -> [PASS] Regime: " << resRod.regime << "\n";
    std::cout << "         -> [PASS] Depth reached via hydrodynamic plasma erosion: "
              << resRod.actual_penetration_depth << " m\n\n";

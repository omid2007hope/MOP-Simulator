...
\subsection{Table 1: Parameterization of Simulated Penetrators}

 Parameter  \\ Cycle 1 (Mk-I)  Cycle 2 (BLU-122/B Mod 3)  \\ Cycle 3 (BLU-122/B Mod 5) |
 :  \\ :  :  \\ : |
 ...
 \textbf{Casing Density (kg/m3$)}  \\ 7850  7850  \\ 15800 |
 ...
 \textbf{$E_{crit}$ (J/m2$)}  \\ $1.2 \times 10^6$  $1.8 \times 10^6$  \\ $3.4 \times 10^6$ |
...
\subsection{Table 2: Terminal Ballistic Shock Dynamics Results}
...
\toprule
\textbf{Variant} & \textbf{Velocity} & \textbf{Energy} & \textbf{Peak {shock}$} & \textbf{Pulse} & \textbf{Failure} & \textbf{Depth} \\
\textbf{} & \textbf{(m/s)} & \textbf{(GJ)} & \textbf{(GPa)} & \textbf{($\mu)} & \textbf{Mode} & \textbf{(m)} \\
\midrule
...
\end{center}
\end{table}
 \textbf{BLU-122/B Mod 3}  \\ 929.00  0.975  \\ 6.68  19.69  \\ Premature SDT  0.00  \\
 \textbf{BLU-122/B Mod 5}  \\ 1229.18  1.624  \\ 17.56  32.10  \\ Premature SDT  0.00  \\
